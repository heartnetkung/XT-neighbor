...
This is the link to [Google Colab Notebook](https://colab.research.google.com/drive/1JbRLtRrmUv9zZollSfT9xp6WqOy7LB7q#scrollTo=emF0vifFye6s) that allows users to quickly use this tool without setting up the GPU environment.
